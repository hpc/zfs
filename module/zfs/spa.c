...
spa_prop_get_config(spa_t *spa, nvlist_t **nvp)
{
	...
	spa_prop_add_list(*nvp, ZPOOL_PROP_ZIA_COMPRESS,
	    NULL, zia_props->compress, ZPROP_SRC_LOCAL);

	spa_prop_add_list(*nvp, ZPOOL_PROP_ZIA_DECOMPRESS,
	    NULL, zia_props->decompress, ZPROP_SRC_LOCAL);

	spa_prop_add_list(*nvp, ZPOOL_PROP_ZIA_CHECKSUM,
	    NULL, zia_props->checksum, ZPROP_SRC_LOCAL);

	spa_prop_add_list(*nvp, ZPOOL_PROP_ZIA_RAIDZ1_GEN,
	    NULL, zia_props->raidz.gen[1], ZPROP_SRC_LOCAL);

	spa_prop_add_list(*nvp, ZPOOL_PROP_ZIA_RAIDZ2_GEN,
	    NULL, zia_props->raidz.gen[2], ZPROP_SRC_LOCAL);

	spa_prop_add_list(*nvp, ZPOOL_PROP_ZIA_RAIDZ3_GEN,
	    NULL, zia_props->raidz.gen[3], ZPROP_SRC_LOCAL);

	spa_prop_add_list(*nvp, ZPOOL_PROP_ZIA_RAIDZ1_REC,
	    NULL, zia_props->raidz.rec[1], ZPROP_SRC_LOCAL);

	spa_prop_add_list(*nvp, ZPOOL_PROP_ZIA_RAIDZ2_REC,
	    NULL, zia_props->raidz.rec[2], ZPROP_SRC_LOCAL);

	spa_prop_add_list(*nvp, ZPOOL_PROP_ZIA_RAIDZ3_REC,
	    NULL, zia_props->raidz.rec[3], ZPROP_SRC_LOCAL);

	spa_prop_add_list(*nvp, ZPOOL_PROP_ZIA_FILE_WRITE,
